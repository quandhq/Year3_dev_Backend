...
def getOptionDayData(day):
    ...
    sensorMonitorList= SensorMonitor.objects.filter(time__gt=day)   #time__gt = "time greater than"
    list_co2 = []
    list_temp = []
    list_hum  = []
    list_time = []
...
def getOptionMonthData(time_start, time_end):
    ...
    sensorMonitorList= SensorMonitor.objects.filter(time__gt=time_start, time__lt=time_end) #time_gt = time greater than
    list_time = []
    list_co2 = []
    list_temp = []
    list_hum  = []
    ...
    table['day'] = table['datetime'].dt.day
    table['hour'] = table['datetime'].dt.hour
    # table = table[table['day'] == (datetime.datetime.fromtimestamp(time_start).day)]
    # print(table)
