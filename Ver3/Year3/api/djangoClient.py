# ########################################################################
# #@brief: file djangoClient.py
# #        This file contains the code for receiving sensor, actuator data 
# #        from gateway, dispatching them and saving them in database.
# ########################################################################
...
#                   VALUES (%s, %s, %s, %s)'''
#          record = (2, data['info']['speed'], data['info']['state'], data['info']['time'])
#          cursor.execute(query, record)
